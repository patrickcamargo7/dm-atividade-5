 ...
 * Use the [ChooserRecipientFragment.newInstance] factory method to
...
class ChooserRecipientFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ChooserRecipientFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ChooserRecipientFragment().apply {
